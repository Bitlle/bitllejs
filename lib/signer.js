...
var Signer = function (bitllejs) {
    ...
    this._NumTo32byteLength = function (value) {
        return leftPad(parseInt(value).toString(16), 64, 0);
    };
...
Signer.prototype.getOrderSign = function (tknSell, tknBuy, price, amount, cell, fee, nonce, privateKey) {
...
Signer.prototype.getDealSign = function (tknSell, tknBuy, amount, cell, fee, nonce, privateKey) {
    tknSell = this.web3.toChecksumAddress(tknSell);
    tknBuy = this.web3.toChecksumAddress(tknBuy);
    ...
    var correctParam = tknSell + tknBuy.slice(2) + this._NumTo32byteLength(amount) + this._NumTo32byteLength(cell) + this._NumTo32byteLength(nonce) + this._NumTo32byteLength(fee);
    var dataToSig = this.web3.sha3(correctParam, {encoding: 'hex'});
    var sign = this._sign(privateKey, dataToSig);
