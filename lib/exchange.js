 ...
 * @param {String} tknToSell
 * @param {String} tknToBuy
 * @param {String} price
 * @param {String} amount
 * @param {String} fee
 * @param {String} privateKey
...
Exchange.prototype.getPlaceOrderArgs = function (tknToSell, tknToBuy, price, amount, fee, privateKey) {
    var cell = this.bitllejs.contracts.ctr.exchange.getFreeCell(tknToSell, tknToBuy).toString();
...
Exchange.prototype.getOrderBook = function (sell, payIn) {
    var prices = this.bitllejs.contracts.ctr.exchange.getOderBookPrices(sell, payIn);
    var amounts = this.bitllejs.contracts.ctr.exchange.getOderBookAmounts(sell, payIn);
